...
class RestrictedUnpickler(pickle.Unpickler):
    ...
    def find_class(self, module: str, name: str) -> type:
        ...
        if module == "NetUtils" and name in {"NetworkItem", "ClientStatus", "Hint", "SlotType", "NetworkSlot", "TriggerableHint", "TextHint", "LocationSetHint", "LocationTrigger", "FreeTrigger"}:
